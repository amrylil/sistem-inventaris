...
<div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-4">
    <div class="mb-3 mb-md-0">
        <h3 class="fw-bold text-dark mb-1">Edit Kategori</h3>
    ...
    <div class="">
        <div class="card card-saas border-0 shadow-sm rounded-4 p-4">
            ...
            <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                ...
                <div>
                    <h5 class="fw-bold mb-0">Update Informasi</h5>
                    <small class="text-muted">Ubah data kategori yang dipilih.</small>
                </div>
            </div>
            ...
            <form action="/category/update/<?php echo $category->id ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nama_kategori" class="form-control bg-light border-start-0" value="<?php echo htmlspecialchars($category->nama_kategori) ?>" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="lokasi_rak" class="form-control bg-light border-start-0" value="<?php echo htmlspecialchars($category->lokasi_rak) ?>">
                    </div>
                </div>

                <div class="mb-4">
                    <label class="form-label fw-bold text-muted small text-uppercase ls-1">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control bg-light" rows="3"><?php echo htmlspecialchars($category->deskripsi) ?></textarea>
                </div>

                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-warning text-white py-2 rounded-3 fw-bold shadow-sm">
